...
I made a script which I use to update all hosted Drupal websites at once. Very simple script, but still so powerful and saves a lot of time. You can find this script at [Github](https://github.com/timoanttila/Drupal-Drush).
